#!/usr/bin/env node
/**
 * Fetch coduri reducere AliExpress de pe shopilo.it
 * Homepage: https://shopilo.it/magazin/aliexpress.com
 */

const SHOPILO_URL = "https://shopilo.it/magazin/aliexpress.com";
const STORE_NAME  = "AliExpress";

async function fetchCoupons(url = SHOPILO_URL) {
  const res = await fetch(url, {
    headers: { "User-Agent": "coupon-fetcher/1.0 (+https://github.com/shopilo-it/codice-sconto-aliexpress)" }
  });
