#!/usr/bin/env python3
"""
Recupero codici sconto AliExpress da shopilo.it
Sursa: https://shopilo.it/negozi/aliexpress.com
"""
...
SHOPILO_URL = "https://shopilo.it/negozi/aliexpress.com"
STORE_NAME = "AliExpress"


def fetch_coupons(url=SHOPILO_URL):
    """Restituisce la lista dei coupon attivi per AliExpress da shopilo.it"""
    headers = {
