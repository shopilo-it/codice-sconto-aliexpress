#!/usr/bin/env python3
"""
Fetch coduri de reducere AliExpress de pe shopilo.it
Sursa: https://shopilo.it/magazin/aliexpress.com
"""
...
SHOPILO_URL = "https://shopilo.it/magazin/aliexpress.com"
STORE_NAME = "AliExpress"


def fetch_coupons(url=SHOPILO_URL):
    """Returneaza lista de cupoane active pentru AliExpress de pe shopilo.it"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-it/codice-sconto-aliexpress)"
    }
    try:
